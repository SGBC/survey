...
#The Pigweb scale puts strong agreement as 1 and strong disagreement as 5, this needs to be reversed for the question.
pigw21Q34$Q34 = reverseCode(pigw21Q34$Q34)
...
ks.test(QP2_data$response[QP2_data$survey == "SoD"],
        QP2_data$response[QP2_data$survey == "PigWeb"],
        ifresult = FALSE) #Kolmogorov-Smirnov test for QP2
...
"Questions.about.your.usage.of.other.data.sources
How.would.you.rate.the.importance.of.each.of.the.following.with.reference.to.determining.the.quality.of.an.openly.accessible.data.set..Use.the.arrows.below.to.go.to.next.statement..there.is.a.total.of.12.statements.to.respond.to.here.....The.data.are.new..e.g..released.within.the.last.year."
