...
sod21 <- read.csv2("~/survey/sod21.csv")
pigw21 <- read.csv("~/survey/pigw21.csv", sep=";") #Note: The original pigw21 file has been altered so that the column showing completion of survey is now last.
...
pigw21 = dplyr::select(pigw21,!1:3)
...
```{r question_4, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE}
#information about research funding, now shown in report
...
```{r question_5, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE, fig.cap="Figure 4"}
...
```{r question_6-8, echo=T, eval = T, message=FALSE, warning=FALSE, fig.show="hold", out.width="50%", results=FALSE, fig.cap=c("Figure 5", "Figure 6", "Figure 5-7")}
#Question 6, 7 and 8 are similar and are therefore displayed together. Kolmogorov smirnov test output from the distributions are hidden in the automated output.
