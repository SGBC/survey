...
# - The plot title 
Q20 = 'To what extent are you comfortable with others using your data for combination reuse?'
...
# Create data frames of answers from both surveys 
# - i.e. extracting the multiple columns of the respective data frame that contains the answers
...
# Identifying the unique answers of the question from both surveys 
# - i.e. answers to the 'other' option
unique(pigw21[,104])
unique(sod21[,38])

# Create data frames of answers to the 'other' option from both surveys 
# - i.e. extracting the column of the respective data frame that contains the 'other' option
