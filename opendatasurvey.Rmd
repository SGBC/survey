...
#The State of Open Data survey contain some unfortunate formatting as it seems to be made up of multiple different surveys stitched together and some questions have been rephrased. 
...
n_columns = length(Q21_levels)

sod21Q21 = as.data.frame(dplyr::select(sod21, (65:sum(65,n_columns,-1))))
sod21Pile = cbind(sod21Pile, sod21Q21)

pigw21Q21 = as.data.frame(dplyr::select(pigw21, (47:sum(47,n_columns,-1))))
pigw21Pile = cbind(pigw21Pile, pigw21Q21)

Q21 = 'What problems/concerns, if any, do you have with sharing datasets?'

Q21_data = format_question_multiple_choice(sod21Q21,
                                          pigw21Q21,
                                          Q21_levels)

plot_multiple_choice(Q21_data,
                     Q21_levels,
                     Q21,
                     "Response")
...
Q45_levels = c("Yes", "No", "I don't know")

Q45_data = format_question_single_choice(sod21Q45$Q45,
                                         pigw21Q45$Q45,
                                         Q45_levels)

plot_single_choice(Q45_data,
                   Q45_levels,
                   Q45,
                   "Area of interest")
```