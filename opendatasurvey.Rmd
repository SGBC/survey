...
```{r question_6, echo=T, eval = T, message=FALSE, warning=FALSE}
...
ks.test(Q6_data$response[Q6_data$survey == "SoD"],
        Q6_data$response[Q6_data$survey == "PigWeb"],
        ifresult = FALSE) #Kolmogorov-Smirnov test for Q6
```

```{r question_7, echo=T, eval = T, message=FALSE, warning=FALSE}
...
Q7 = 'Making research articles open access should be common scholarly practice'
...
ks.test(Q7_data$response[Q7_data$survey == "SoD"],
