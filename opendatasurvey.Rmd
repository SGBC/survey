...
GitHub - Awareness and use of GitHub

```{r question_25_github, echo=T, eval=T, message=FALSE, warning=FALSE, results=FALSE}

# This is a single choice question without an "other"
# with responses only in the PigWeb survey.

pigw21Q25_GitHub = as.data.frame(dplyr::select(pigw21, 90))

Q25_GitHub = 'Are you aware of any of the following data or code sharing platforms? - GitHub'

colnames(pigw21Q25_GitHub) = c('Q25_GitHub')

Q25_GitHub_levels = c("No",
                      "Yes but I have not used it",
                      "Yes and I have used it")

Q25_GitHub_data = format_question_single_choice_pigweb(
  pigw21Q25_GitHub$Q25_GitHub,
  Q25_GitHub_levels
)
...
Zenodo - Awareness and use of Zenodo 
 
```{r question_25_zenodo, echo=T, eval=T, message=FALSE, warning=FALSE, results=FALSE} 
 
# This is a single choice question without an "other" 
# with responses only in the PigWeb survey. 
 
pigw21Q25_Zenodo = as.data.frame(dplyr::select(pigw21, 91)) 
 
Q25_Zenodo = 'Are you aware of any of the following data or code sharing platforms? - Zenodo' 
 
colnames(pigw21Q25_Zenodo) = c('Q25_Zenodo') 
 
Q25_Zenodo_levels = c("No", 
                      "Yes but I have not used it", 
                      "Yes and I have used it") 
 
Q25_Zenodo_data = format_question_single_choice_pigweb( 
  pigw21Q25_Zenodo$Q25_Zenodo, 
  Q25_Zenodo_levels 
) 
...
```{r question_26, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE, fig.cap="Figure 26"}

#Creating data sets for Q26/Isolating the responses from Q26
pigw21Q26 = as.data.frame(dplyr::select(pigw21, 97))
pigw21Pile = cbind(pigw21Pile, pigw21Q26)

sod21Q26 = as.data.frame(dplyr::select(sod21, 31))
sod21Pile = cbind(sod21Pile, sod21Q26)

#Saving the Question text and changing the column name with the responses in the two data frames to Q26 
Q26 = "At which point during the research cycle, if at all, do you make your data available?"
colnames(pigw21Q26) = c('Q26')
colnames(sod21Q26) = c('Q26')

#Changing names so answers from both surveys match
pigw21Q26$Q26[pigw21Q26$Q26 == "1"] <- "Immediately at the point when data is collected"
pigw21Q26$Q26[pigw21Q26$Q26 == "2"] <- "When the research is complete"
pigw21Q26$Q26[pigw21Q26$Q26 == "3"] <- "When submitting a research article"
pigw21Q26$Q26[pigw21Q26$Q26 == "4"] <- "On publication of the research"
  pigw21Q26$Q26[pigw21Q26$Q26 == "5"] <- "Upon request from others"
  pigw21Q26$Q26[pigw21Q26$Q26 == "6"] <- "I do not share my data beyond my immediate collaborators"


totalQ26 <- rbind(pigw21Q26, sod21Q26)

totalQ26 <- na.omit(totalQ26)

#sum(sod21Q26$Q26=="")

#table(sod21Q26$Q26)

merged_Q26 <- data.frame(
    Q26 = c(1:6), 
    Response = c("Immediately at the point when data is collected", "When the research is complete", 
                    "When submitting a research article", "On publication of the research", 
                    "Upon request from others", "I do not share my data beyond my immediate collaborators"),
    stringsAsFactors = FALSE
)

merged_Q26$count <- c("192", "631", 
                       "836", "1337",
                       "943", "428")

merged_Q26$count <- as.numeric(as.character(merged_Q26$count))
merged_Q26$Percent <- merged_Q26$count/sum(merged_Q26$count)*100

ggplot(data = merged_Q26, mapping = aes(x = Response, y = Percent, fill = Response)) + 
  geom_bar(stat = "identity" ) +
  theme(axis.text.x=element_blank(),
        axis.ticks.x=element_blank()) +
          ggtitle("At which point during the research cycle, if at all, 
                  do you make your data available?") +
            labs(y= "Percent", x = "Response (PigWeb + SoD)")
...
How, if at all, do you monitor the use of data that you share publicly? \* Citations \* Resolutions \* Download \* Altmetrics \* I do not monitor the use of my data \* Other(please specify)
...
Have you ever been involved in a collaboration as a result of data you have previously shared? \* Yes \* No \* I don't know
...
**Would you like more guidance on how to comply with the policies of any of the below on making your research data openly available?**

```{r question_32, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE, fig.cap="Figure 32"}
...
Q32_levels = c("Funder",
              ...
              "Government",
              "None of the above")
n_columns = length(Q32_levels)

# Double check that the columns correspond to the right question:
# colnames(sod21)[96]
# colnames(pigw21)[76]

sod21Q32 = as.data.frame(dplyr::select(sod21, (96:sum(96,n_columns,-1))))
sod21Pile = cbind(sod21Pile, sod21Q32)

pigw21Q32 = as.data.frame(dplyr::select(pigw21, (76:sum(76,n_columns-1))))
pigw21Pile = cbind(pigw21Pile, pigw21Q32)

Q32 = 'Would you like more guidance on how to comply with the policies of any of the below on making your research data openly available?'

Q32_data = format_question_multiple_choice(sod21Q32,
                                          pigw21Q32,
                                          Q32_levels)

plot_multiple_choice(Q32_data,
                     Q32_levels,
                     Q32,
                     "Response")
```
...
**How would you rate the importance of the following with reference to determining the quality of an openly accessible data set? The data are available from a publicly available repository.**

```{r question_33, echo=T, eval = T, message=FALSE, warning=FALSE, results=T, fig.cap="Figure 33"}

# Answered by Yishu

#This code chunk uses the likert scale functions.

# Double check that the columns correspond to the right question:
# colnames(sod21)[127]
# colnames(pigw21)[124]

#Creating data sets for Q33 (In otherwords: Isolating the responses of Q33 in the two surveys and adding this to a compiled data set, one for each survey)
sod21Q33 = as.data.frame(dplyr::select(sod21,127))
sod21Pile = cbind(sod21Pile, sod21Q33)

pigw21Q33 = as.data.frame(dplyr::select(pigw21, 124))
pigw21Pile = cbind(pigw21Pile, pigw21Q33)


#Setting columnnames and storing the question for Q33
colnames(sod21Q33) = c('Q33')
colnames(pigw21Q33) = c('Q33')
Q33 = 'How would you rate the importance of the following with reference to determining the quality of an openly accessible data set? The data are available from a publicly available repository.'

#Setting the answer options to Q33.
Q33_levels = c("Extremely important", "Somewhat important",
               "Moderately important", "Slightly important",
               "Not at all important", "I don't know")

#The Pigweb scale is correctly formatted for this question (Q33), thus no need to reverse the question.
#pigw21Q33$Q33 = reverseCode(pigw21Q33$Q33) 

Q33_data = format_question_likert(sod21Q33$Q33, #Making the answers to Q33 in the two questionnaires comparable, merging them to one data frame 
                                  pigw21Q33$Q33,
                                  Q33_levels)

plot_likert(Q33_data,  #Plotting the Level of importance
            Q33_levels,
            Q33,
            "Level of importance")
...
SvPQ33 = ks.test(Q33_data$response[Q33_data$survey == "SoD"],
                 Q33_data$response[Q33_data$survey == "PigWeb"],
                 ifresult = FALSE) #Kolmogorov-Smirnov test for Q33
SvPQ33
```
...
> **Since January 2020, have you reused any of the below as part of your research?**
>
...
```{r question_32.1, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE, fig.cap="Figure 32.1", out.width="50%"}

# Answered by Lina

# This is a multiple-choice question stored as one indicator column per response option. 

# Checking that index corresponds to right question
# colnames(sod21)[101:103] 
# colnames(pigw21)[115:117]

# Giving the answer options to Question 32 - the ticks on the x axis when plotting
Q32.1_levels = c("Your own data",
              "Openly accessible data shared by other research groups",
              "Neither of the above")

# Create data frames of answers from both surveys - by extracting the multiple columns of the respective data frame that contains the answers
pigw21Q32.1 <- as.data.frame(dplyr::select(pigw21, 115:117))
sod21Q32.1 = as.data.frame(dplyr::select(sod21, 101:103))

# Checking if there are any individuals with no answer to the question - if either is TRUE add a "no answer" level
# all(rowSums(is.na(pigw21Q32.1)) == ncol(pigw21Q32.1))
# all(rowSums(sod21Q32.1 == 0) == ncol(sod21Q32.1))

# Storing the question - later used to give our plot a title 
Q32.1 <- 'Since January 2020, have you reused any of the below as part of your research?'

# Creating a data frame containing percentages for each option for plotting multiple-choice questions: arguments in this order:
# 1. sod_data (represent columns with each available answers)
# 2. pigweb_data (represent columns with each available answers)
# 3. levels is a vector of the options
Q32.1_data <- format_question_multiple_choice(sod21Q32.1,
                                          pigw21Q32.1,
                                          Q32.1_levels)

# Plotting a bar chart of percentages for a multiple choice questions: arguments in this order:
# 1. Data frame produced by format_question_multiple_choice
# 2. Vector of the answer options
# 3. Character string of plot title - Q32 question
# 4. Character string for the x-axis label (not a separate vector, write text below)
plot_multiple_choice(Q32.1_data,
                     Q32.1_levels,
                     Q32.1,
                     "Response")
...
> **How do you think the data shared by others has or could benefit you?**
>
> Please select all that apply:
>
...
```{r question_33.1, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE, fig.cap="Figure 33.1", out.width="50%"}
...
#Checking that index corresponds to right question 
# colnames(sod21)[106:112] 
# colnames(pigw21)[118:124]

# Giving the answer options to Question 33 - the ticks on the x axis when plotting
Q33.1_levels = c("Fosters collaboration", "Validates findings", "Complements data", "Avoids duplication", "No benefit", "Other")

# Create data frames of answers from both surveys - by extracting the multiple columns of the respective data frame that contains the answers

pigw21Q33.1 <- as.data.frame(dplyr::select(pigw21, 118:123)) 
sod21Q33.1 = as.data.frame(dplyr::select(sod21, 106:109,111,110))

# Checking if there are any individuals with no answer to the question - if either is TRUE add a "no answer" level
# all(rowSums(is.na(pigw21Q33.1)) == ncol(pigw21Q33.1))
# all(rowSums(sod21Q33.1 == 0) == ncol(sod21Q33.1))

# Storing the question - later used to give our plot a title
Q33.1 <- 'Since January 2020, have you reused any of the below as part of your research?'

# Creating a data frame containing percentages for each option for plotting multiple-choice questions: arguments in this order:
# 1. sod_data (represent columns with each available answers)
# 2. pigweb_data (represent columns with each available answers)
# 3. levels is a vector of the options
Q33.1_data <- format_question_multiple_choice(sod21Q33.1, pigw21Q33.1, Q33.1_levels)
...
plot_multiple_choice(Q33.1_data, Q33.1_levels, Q33.1, "Response")
```

# Question 34

```{r question_Q34, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE, fig.cap="Figure Q34"}
pigw21Q34 = as.data.frame(dplyr::select(pigw21, 126))
pigw21Pile = cbind(pigw21Pile, pigw21Q34)

#Setting column names and storing the question
colnames(pigw21Q34) = c('Q34')
Q34 = 'How would you rate the importance of each of the following with reference to determining the quality of an openly accessible data set? : The data are available from a publicly available repository.'

#Setting the answer options to Question Q19.
Q34_levels = c("Extremely important", "Somewhat important", "Moderately important", "Slightly importat", "Not at all important", "I don't know")

sod21Q34 = as.data.frame(dplyr::select(sod21,129))
sod21Pile = cbind(sod21Pile, sod21Q34)
colnames(sod21Q34) = c('Q34')


Q34_data = format_question_likert(sod21Q34$Q34,
                                 pigw21Q34$Q34,
                                 Q34_levels)

#Likert plot
plot_likert(Q34_data,
            Q34_levels,
            Q34,
            "Level of importance")
...
ks.test(Q34_data$response[Q34_data$survey == "SoD"],
        Q34_data$response[Q34_data$survey == "PigWeb"],
        ifresult = FALSE) #Kolmogorov-Smirnov test for Q34

```

```{r question_QP3, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE, fig.cap="Figure QP3"}
#Paulina Q3
#What areas (if any) do you feel you need help with in regard to making your research data openly available.
#This code chunk uses the multiple choice functions.
QP3_levels = c("Finding the time to manage my data",
              "Data management plans",
              "Copyright/Licensing of data",
              "Data management policies",
              "Curation of data",
              ...
              "None of the abobe",
              "Other")
n_columns = length(QP3_levels)

sod21QP3 = as.data.frame(dplyr::select(sod21, (87:sum(87,n_columns,-1))))
sod21Pile = cbind(sod21Pile, sod21QP3)

pigw21QP3 = as.data.frame(dplyr::select(pigw21, (67:sum(67,n_columns-1))))
pigw21Pile = cbind(pigw21Pile, pigw21QP3)

QP3 = 'What areas (if any) do you feel you need help with in regard to making your research data openly available'


QP3_data = format_question_multiple_choice(sod21QP3,
                                          pigw21QP3,
                                          QP3_levels)

plot_multiple_choice(QP3_data,
                     QP3_levels,
                     QP3,
                     "Response")
```
...
```{r question_37, echo=T, eval = T, message=FALSE, warning=FALSE, results=T, fig.cap="Figure 37"}
...
# colnames(pigw21)[127]
#Keep only the Q37
sod21Q37 = as.data.frame(dplyr::select(sod21, 130))
sod21Pile = cbind(sod21Pile, sod21Q37)

pigw21Q37 = as.data.frame(dplyr::select(pigw21, 127))
pigw21Pile = cbind(pigw21Pile, pigw21Q37)

#Setting columnnames and question 37
colnames(sod21Q37) = c('Q37')
colnames(pigw21Q37) = c('Q37')

Q37 = 'How would you rate the importance of the following when determining the quality of an openly accessible data set: The data come from a known source (e.g. familiar institution or academic)?'

#Setting the answer options to Q37.
Q37_levels = c("Extremely important", "Somewhat important",
               "Moderately important", "Slightly important",
               "Not at all important", "I don't know")

Q37_data = format_question_likert(sod21Q37$Q37, #Making the answers to Q37 in the two questionnaires comparable, merging them to one data frame 
                                  pigw21Q37$Q37,
                                  Q37_levels)

plot_likert(Q37_data,  #Plotting the Level of importance
            Q37_levels,
            Q37,
            "Level of importance")
```
...
```{r question_38, echo=T, eval = T, message=FALSE, warning=FALSE, results=T, fig.cap="Figure 38"}
...
# colnames(pigw21)[128]
#Keep only the Q38
sod21Q38 = as.data.frame(dplyr::select(sod21, 131))
sod21Pile = cbind(sod21Pile, sod21Q38)

pigw21Q38 = as.data.frame(dplyr::select(pigw21, 128))
pigw21Pile = cbind(pigw21Pile, pigw21Q38)

#Setting columnnames and question 38
colnames(sod21Q38) = c('Q38')
colnames(pigw21Q38) = c('Q38')

Q38 = 'How would you rate the importance of the following when determining the quality of an openly accessible data set: The data are in a repository that I know checks/curates the data?'

# Setting the answer options to Q38
Q38_levels = c("Extremely important", "Somewhat important",
               "Moderately important", "Slightly important",
               "Not at all important", "I don't know")


# The PigWeb scale is correctly formatted for this question, thus no need to reverse the question.

Q38_data = format_question_likert(
  sod21Q38$Q38,
  pigw21Q38$Q38,
  Q38_levels)
...
"Questions.about.your.usage.of.other.data.sources How.would.you.rate.the.importance.of.each.of.the.following.with.reference.to.determining.the.quality.of.an.openly.accessible.data.set..Use.the.arrows.below.to.go.to.next.statement..there.is.a.total.of.12.statements.to.respond.to.here.....The.data.are.new..e.g..released.within.the.last.year."

```{r Leonie question_1, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE}
#Creating data sets for column 125 and 128
pigw21Qleonie1 = as.data.frame(dplyr::select(pigw21, 125))
pigw21Pile = cbind(pigw21Pile, pigw21Qleonie1)

sod21Qleonie1 = as.data.frame(dplyr::select(sod21, 128))
sod21Pile = cbind(sod21Pile, sod21Qleonie1)



#Saving the Question text and changing the column name with the responses in the two data frames to Q45 
Qleonie1 = "How would you rate the importance of new data (released within the year) with reference to determining the quality of an openly accessible data set? "
colnames(pigw21Qleonie1 ) = c('Qleonie1 ')
colnames(sod21Qleonie1 ) = c('Qleonie1 ')

Qleonie1_levels = c("Extremely important", "Somewhat important", "Moderately important","Slightly important","Not at all important","I don´t know") #The different levels/categories of the questions

Qleonie1_data = format_question_single_choice(sod21Qleonie1$Qleonie1, #Making the answers to Q45 in the two questionnaires comparable, merging them to one data frame 
                                         pigw21Qleonie1$Qleonie1,
                                         Qleonie1_levels)

plot_single_choice(Qleonie1_data, #Plotting the responses
                   Qleonie1_levels,
                  Qleonie1,
                   "Response")
```

About.your.research.data...Are.you.aware.of.any.of.the.following.data.or.code.sharing.platforms....EOSC..European.Open.Science.Cloud.

```{r Leonie question_2, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE}
#This is a single choice question without an "other" with responses only in the PigWeb survey.

pigw21Qleonie2 = as.data.frame(dplyr::select(pigw21, 89))


Qleonie2 = 'About your research.data, are you aware of EOSC (European Open Science Cloud)'
colnames(pigw21Qleonie2) = c('Qleonie2')

Qleonie2_levels = c("No", "Yes but I have not used it ", "Yes and I have used it")

#The function is given a 0 instead of the column expected form the SoD survey as there is no question in it.
Qleonie2_data = format_question_single_choice_pigweb(pigw21Qleonie2$Qleonie2,
                                       Qleonie2_levels)

plot_single_choice(Qleonie2_data,
                   Qleonie2_levels,
                   Qleonie2 ,
                   "Answers")
```
...
**Were you able to get access to the data set?**

```{r question_55, echo = TRUE, eval = TRUE, message = FALSE, warning = FALSE, results = FALSE, fig.cap = "Figure 55"}
# Answered by Awa
...
sod21Q55 <- as.data.frame(dplyr::select(sod21, 141))
pigw21Q55 <- as.data.frame(dplyr::select(pigw21, 165))


# Name the columns and store the question text
colnames(sod21Q55) <- "Q55"
colnames(pigw21Q55) <- "Q55"
Q55 <- "Were you able to get access to the data set?"


# Define the response categories
# PigWeb codes confirmed against the questionnaire (Q4.8):
# 1 = Yes, the complete data set
# 2 = Yes, part of the data set
# 3 = No, I was unable to access the data set
Q55_levels <- c("Yes, the complete data set",
               "Yes, part of the data set",
               "No, I was unable to access the data set")


# Blank responses are treated as missing by the formatting function.
# Format the data for both surveys
Q55_data <- format_question_single_choice(sod21Q55$Q55,
                                          pigw21Q55$Q55,
                                          Q55_levels)


# Plot the results
plot_single_choice(Q55_data,
                   Q55_levels,
                   Q55,
                   "Response")
```
...
**Were you able to reuse the dataset for your intended purpose?**

```{r question_56, echo = TRUE, eval = TRUE, message = FALSE, warning = FALSE, results = FALSE, fig.cap = "Figure 56"}
# Answered by Awa
...
# Extract the relevant columns
sod21Q56 <- as.data.frame(dplyr::select(sod21, 152))
pigw21Q56 <- as.data.frame(dplyr::select(pigw21, 166))


# Name the columns and store the question text
colnames(sod21Q56) <- "Q56"
colnames(pigw21Q56) <- "Q56"
Q56 <- "Were you able to reuse the dataset for your intended purpose?"


# Define the response categories
# PigWeb codes confirmed against the questionnaire (Q4.11): 1 = Yes, 2 = No
Q56_levels <- c("Yes", "No")


# Blank responses indicate that the question was not reached and are treated as missing.
# Format the data for both surveys
Q56_data <- format_question_single_choice(sod21Q56$Q56,
                                          pigw21Q56$Q56,
                                          Q56_levels)
# Plot the results
plot_single_choice(Q56_data,
                   Q56_levels,
                   Q56,
                   "Response")
```
...
```{r question_59, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE, fig.cap="Figure 59"}

# single choice categorical question - uses the single choice functions

# index check
# colnames(pigw21)[169]
# colnames(sod21)[160]

# creating dataframes of answers for both surveys:
# extracting answer columns and adding the questions to the pile
pigw21Q59 = as.data.frame(dplyr::select(pigw21, 169))
pigw21Pile = cbind(pigw21Pile, pigw21Q59)

sod21Q59 = as.data.frame(dplyr::select(sod21, 160))
sod21Pile = cbind(sod21Pile, sod21Q59)

# setting column names and storing the question text
colnames(pigw21Q59) = c('Q59')
colnames(sod21Q59) = c('Q59')
Q59 = 'Do you think researchers currently get sufficient credit for sharing data?'

# recoding decisions for the different wording: 
# "Not Sure" was folded into "I don't know". "No" was set to NA as there is no indication whether it refers to "No, too little" or "no, too much". "" was also set to NA.

sod21Q59$Q59[sod21Q59$Q59 == "Not sure"] <- "I don't know"
sod21Q59$Q59[sod21Q59$Q59 == "No"] <- NA
sod21Q59$Q59[sod21Q59$Q59 == ""] <- NA

# answer options in the order listed by the pigweb questionnaire because format_question_single_choice() has the SoD text by position while the pigweb 1-4 answers are used as they are:
Q59_levels = c("Yes",
...
Q59_data = format_question_single_choice(sod21Q59$Q59,
                                         pigw21Q59$Q59,
                                         Q59_levels)

# plot 
plot_single_choice(Q59_data, # dataframe
                   Q59_levels, # answer options
                   Q59, # title 
                   "Response") + 
...
```{r question_64, echo=T, eval = T, message=FALSE, warning=FALSE, results=FALSE, fig.cap="Figure 64"}

# five-level ordinal/Likert question from strongly oppose to strongly support. 
# uses likert scale functions
...
# creating dataframes of answers for both surveys:
# extracting answer columns and adding the questions to the pile
pigw21Q64 = as.data.frame(dplyr::select(pigw21, 201))
pigw21Pile = cbind(pigw21Pile, pigw21Q64)

sod21Q64 = as.data.frame(dplyr::select(sod21, 193))
sod21Pile = cbind(sod21Pile, sod21Q64)

# setting column names and storing the question text
colnames(pigw21Q64) = c('Q64')
colnames(sod21Q64) = c('Q64')
Q64 = 'How supportive would you be of a national mandate for making research data openly available?'

# there are two different strings (Strongly Support and Strongly support/xa0) that mean the same thing
# however, trimws() alone will not merge them as \xa0 is not a plain space. 
sod21Q64$Q64 <- gsub("\xa0", "", sod21Q64$Q64, useBytes = TRUE)
sod21Q64$Q64 <- trimws(sod21Q64$Q64)

# setting "" to NAs
sod21Q64$Q64[sod21Q64$Q64 == ""] <- NA

# ordering levels as indicated in the instructions: 
Q64_levels = c("Strongly oppose",
               "Somewhat oppose",
               "Neutral",
               "Somewhat support",
               "Strongly support")

# on the questionnaire the options are listed in the opposite direction (e.g. 1 = "Strongly Support", 5 = "strongly oppose")
# format_question_likert() has the SoD text by the position in the Q64_levels, so the pigweb codes must be reversed:
pigw21Q64$Q64 = reverseCode(pigw21Q64$Q64)

# combining the two surveys
Q64_data = format_question_likert(sod21Q64$Q64,
                                  pigw21Q64$Q64,
                                  Q64_levels)
# plot 
plot_likert(Q64_data,
            Q64_levels,
            Q64,
            "Level of agreement")
