...
# Data to be analysed in the chunk is copied to the Q20 data frame and the pile before being removed from the data frame. The process is repeated for each question in it's respective chunk
...
# unique(sod21Q20) #unique() is used to identify the unique answers of the question. It is commented out here to make the Notebook tidier
...
# Plot the response (excluding 'other' option)
